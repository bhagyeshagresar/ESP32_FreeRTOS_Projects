//Dining Philisophers Problem - Deadlock prevention using Arbirartor(also solves livelock) - Credits Shawyn Hymel
...
static SemaphoreHandle_t arbitrator; //arbirator mutex
