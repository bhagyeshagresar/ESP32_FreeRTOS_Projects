// ESP32 Priority Inversion Demo - Credits Shawyn Hymel
...
void setup() {
 // Configure Serial
  ...
  lock = xSemaphoreCreateBinary(); // we use a semaphore here as createMutex takes care of prirority inversion for us
